...
class ImageHorizontalContainer extends React.PureComponent<Props, State> {
  ...
  render() {
    ...
    return (
      ...
      <View style= {Platform.OS == 'ios' ? { position: 'relative'} : { position: 'absolute', top: 0, left: 0}}>
      ...
      <FlatList
        ...
        maxToRenderPerBatch= {this.props.images.length }
        initialNumToRender={Platform.OS === 'ios' ? this.props.images.length : this.props.images.length}
