...
import { Easing, Platform, Animated, StyleSheet, Dimensions, TouchableOpacity, Text } from 'react-native'
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <TouchableOpacity  style={{position: 'absolute', right: 10, top: 10, zIndex: 10}} onPress={this.props.onClose}>
            <Text style={{color: 'white', fontSize: 20, marginTop: 20}}> Close </Text>
        </TouchableOpacity>
      </Animated.View>
    )
  }
